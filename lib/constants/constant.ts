...
export const NOTABLE_WORDS_MINIMUM_REVIEW_COUNT = 3;
export const NOTABLE_WORDS_LIMIT = 20;

export const REFETCH_NOTABLE_WORDS_INTERVAL = 12000;

export const LIMIT_WORDS_COUNT_STOP_EXPLORING = 200;
export const DEFAULT_DAILY_WORD_GOAL = 10;

export const DEFAULT_DAILY_AI_REQUEST = 20;
export const DEFAULT_MONTHLY_AI_REQUEST = 300;
